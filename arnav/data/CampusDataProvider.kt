...
object CampusDataProvider {
    ...
    fun createSampleCampusGraph(): CampusGraph {
        return CampusGraphBuilder()
            ...
            // Add outdoor path nodes (key intersections)
            .addPathNode("main_gate", CampusLocation("main_gate", 9.847875487714289, 122.88741459467961))
